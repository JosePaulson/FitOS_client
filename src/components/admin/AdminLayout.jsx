...
const NAV = [
  ...
  { to: '/dashboard/timetable',      icon: '🗓️', label: 'Timetable',      roles: ['owner', 'manager', 'trainer'] },
  ...
  { to: '/dashboard/exercise-catalog',icon: '📝', label: 'Exercise Catalog',roles: ['owner', 'manager'] },
